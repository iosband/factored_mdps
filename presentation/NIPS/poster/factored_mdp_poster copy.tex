...
\definecolor{midgrey}{rgb}{0.33,0.33,0.33}
...
bgColorOne=darkgrey, % Background color for the gradient on the left side of the poster
bgColorTwo=darkgrey, % Background color for the gradient on the right side of the poster
...
boxColorOne=darkgrey, % Background color of the content boxes
...
{\color{white} \bf\textsc{Near-Optimal Reinforcement Learning \\ \vspace{1mm} in Factored MDPs}\vspace{0.5em}} % Poster title
{\color{white} \textsc{ Ian Osband and Benjamin Van Roy \hspace{12pt} Stanford University}} % Author names and institution
...
{\color{white} \captionof{figure}{classic reinforcement learning setting}}
\end{center}
\vspace{-15pt}
