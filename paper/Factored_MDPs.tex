...
For a factored MDP with $m$ independent components with $S$ states and $A$ actions the bound $\tilde{O}(m S \sqrt{AT})$ is close to the lower bound $\Omega(m\sqrt{SAT})$ and so we claim that the bound is near optimal.
